...
//     printf("\n Input func_num %d Running fun num%d  \n", func_num0, func_num);
	...
	if (ini_flag==0)
	{
		...
		sprintf(FileName, "../functions/cec2020/boundConstrained/input_data/M_%d_D%d.txt", func_num,nx);
		...
		sprintf(FileName, "../functions/cec2020/boundConstrained/input_data/shift_data_%d.txt", func_num);
		fpt = fopen(FileName,"r");
		if (fpt==NULL)
		{
		...
		if (func_num==4||func_num==6||(func_num>=11&&func_num<=20))//4 hf01 6 hf03 in cec2020**
		{
			...
			sprintf(FileName, "../functions/cec2020/boundConstrained/input_data/shuffle_data_%d_D%d.txt", func_num, nx);
			fpt = fopen(FileName,"r");
			if (fpt==NULL)
			{
